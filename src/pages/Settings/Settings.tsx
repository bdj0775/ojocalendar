...
const SettingsPage = () => {
  ...
  const {
    ...
    setOnboardingCompleted, resetOnboarding, deleteAccount,
  } = useStore();
  ...
  return (
    <div className="bg-background min-h-screen pb-28">
      ...
      <div className="px-4">
        ...
        <p className="text-center text-[11px] text-muted-foreground/40 mt-4 mb-2">Version 3.0.1</p>
            ...
            <div className="w-full max-w-sm bg-card rounded-2xl p-6 flex flex-col gap-4 shadow-xl">
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-destructive text-white text-[13px] font-semibold transition-all disabled:opacity-50"
                >
